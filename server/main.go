...
КОМАНДЫ:
  ...
  /msg <комната> <текст>
	  ...
	  /m [комната]
	      Начать многострочный ввод. Каждая строка добавляется в буфер.
	      Завершите ввод командой /end — всё отправится одним сообщением.
	      Если комната не указана, используется текущая (/switch).
	      Пример:
	        /m друзья
	        первая строка
	        вторая строка
	  ...
	  /end
	      Отправить набранный многострочный текст (см. /m).
